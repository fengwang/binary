#ifndef _BINARY_HPP_INCLUDED_FSDOIJAPOI4EHP89ASFHIOASFHOUASFDKADFHUIOUHASFDKLJSDFAHSADFHJFDIHFDJFFFFOSIJFSDDD 
#define _BINARY_HPP_INCLUDED_FSDOIJAPOI4EHP89ASFHIOASFHOUASFDKADFHUIOUHASFDKLJSDFAHSADFHJFDIHFDJFFFFOSIJFSDDD 
...
namespace binary_private_afdsiuoh4879yasfdkhjlawf89y74rliuhasf8ghsf
{
    ...
    {
        static const value_type value = ( binary_impl<_0_or_1>::value << sizeof...( rest_0_1_series ) ) + 
...
{
    static_assert ( sizeof...( _0_1_series ) < (sizeof(binary_private_afdsiuoh4879yasfdkhjlawf89y74rliuhasf8ghsf::value_type) << 3), 
                    "Error: too long a binary integer series." );
